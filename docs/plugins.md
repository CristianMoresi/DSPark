...
|---|---|
| [`plugin_saturator/`](https://github.com/CristianMoresi/DSPark/blob/main/examples/plugin_saturator/saturator.cpp) | the minimum: one effect, one file, three formats |
| [`plugin_template/`](https://github.com/CristianMoresi/DSPark/blob/main/examples/plugin_template/plugin_template.cpp) | every optional contract method, present and commented (uses `PluginBase`) |
| [`plugin_ducker/`](https://github.com/CristianMoresi/DSPark/blob/main/examples/plugin_ducker/ducker.cpp) | a sidechain input the host can route into |
| [`plugin_synth/`](https://github.com/CristianMoresi/DSPark/blob/main/examples/plugin_synth/synth.cpp) | an instrument: MIDI in, voices, no audio input, factory presets |
| [`plugin_webview_editor/`](https://github.com/CristianMoresi/DSPark/blob/main/examples/plugin_webview_editor/webview_saturator.cpp) | a custom HTML/CSS/JS GUI in a single file (knobs, gestures) |
| [`plugin_webview_files/`](https://github.com/CristianMoresi/DSPark/tree/main/examples/plugin_webview_files) | the production GUI workflow: separate `ui/` files embedded by CMake |
...
[`examples/plugin_webview_editor/`](https://github.com/CristianMoresi/DSPark/blob/main/examples/plugin_webview_editor/webview_saturator.cpp).
